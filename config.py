class Config:
    def __init__(self, args):
        ...
        self.num_pruning_iters = args.num_pruning_iters #4
        ...
        elif any([k in args.arch for k in ['vit-huge']]):
            self.hidden_dim = 1280  # ViT-Huge的hidden dimension
        ...
        self.training_params = {
            ...
            'vit-huge': {
                'data_default': {
                    'init': {
                        'num_train_epochs': 2,
                        'learning_rate': 5e-5  # 更小的学习率用于超大模型
                    },
                    'iter': {
                        'num_train_epochs': 2,
                        'learning_rate': 5e-5
